...
pub unsafe fn load_assembly_appdomain(
    ...
    // ICLRMetaHost VTable: [0]=QI, [1]=AddRef, [2]=Release, [3]=GetRuntime, ...
    ...
    // ICLRRuntimeInfo VTable: [9]=GetInterface
    ...
    // ICLRRuntimeHost2 VTable: [3]=Start, [11]=ExecuteInDefaultAppDomain
    ...
    // Note: first arg after self is assembly PATH (wide string), not bytes.
    // Passing assembly_bytes as *const u16 here is intentional for .config hijacking scenario.
    exec(
        runtime_host,
